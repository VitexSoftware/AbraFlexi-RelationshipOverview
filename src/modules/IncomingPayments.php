    ...
    public function dig()
    {
        ...
        if (empty($outInvoicesData)) {
            ...
            foreach ($outInvoicesData as $incomingPaymentData) {
                ...
                $banka = \AbraFlexi\RO::uncode((string) $incomingPaymentData['banka']);
                ...
                unset($incomingPaymentData['id'], $incomingPaymentData['mena'], $incomingPaymentData['storno'], $incomingPaymentData['banka@ref'], $incomingPaymentData['banka'], $incomingPaymentData['mena@ref'], $incomingPaymentData['mena@showAs']);
